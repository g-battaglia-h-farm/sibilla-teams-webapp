        ...
        generateBundle(options, bundle) {
            for (const fileName in bundle) {
                ...
                if (chunk.type === 'chunk' && fileName.endsWith('.js')) {
                    ...
                    chunk.code = chunk.code.replace(/Impossibile connettersi\./g, 'Impossibile connettersi, prova a ricaricare la pagina! Qualora il problema dovesse persistere, contatta l\'assistenza.');
                }
            }
        },
    };
